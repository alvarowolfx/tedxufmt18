<div id="fh5co-our-services" data-section="tedx">
    <div class="container">
        <div class="row row-bottom-padded-sm">
            <div class="col-md-12 section-heading text-center">
                <h2 class="to-animate">TEDxUFMT</h2>
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 to-animate">
                        <h3 style="text-align:center;font-size: 20px;"> 
                            ...
                            iniciativas e projetos, inspirando, conectando e transformando Uberaba em um 
                            polo de boas ideias e ações. Escolhemos o tema Metamorfose pois queremos 
