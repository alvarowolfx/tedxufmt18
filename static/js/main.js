(function() {
  ...
  var registerInscricaoForm = function() {
    var form = $('#inscricaoForm');
    form.submit(function(e) {
      var formData = {
        email: $('#inscricaoForm input[name=email]').val()
      };
      ...
      $.ajax({
        ...
        console.log('Form ahoy: ', response);
        $('#msgInscricao').html(response);
      });
